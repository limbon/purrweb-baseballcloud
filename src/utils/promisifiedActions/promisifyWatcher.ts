...
import { START_WATCH_PROMISIFIED_ACTION, STOP_WATCH_PROMISIFIED_ACTION } from './constants';
...
function* handleRoutineAction({ success, failure, cancelAction, taskId, resolve, reject }) {
